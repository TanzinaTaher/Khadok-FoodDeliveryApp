...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Food List with price");
    ...
    private void GetDataFromFirebase() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                recyclerAdapter = new RecyclerAdapter2(getApplicationContext(),ModelList);
    ...
    {
        ArrayList<Model2>mylist = new ArrayList<>();

        for(Model2 model2:ModelList)
        {
        ...
        RecyclerAdapter2 recyclerAdapter_search = new RecyclerAdapter2(getApplicationContext(),mylist);
